...
var FirebaseDao = /** @class */ (function () {
    ...
    FirebaseDao.prototype.getProducts = function () {
        ...
        (function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db.collection("productos").get()];
                    case 1:
                        snapshot = _a.sent();
    ...
    FirebaseDao.prototype.getProductById = function (id) {
        ...
        console.log(product);
        var queryRef = collection.where("id", "==", id);
    ...
    FirebaseDao.prototype.insertProduct = function (product) {
        ...
        this.products.push(__assign({}, newProduct));
        this.count++;
    ...
    FirebaseDao.prototype.updateProduct = function (product, id) {
        var date = new Date();
        var templateDate = date.getDate() + "/" + (date.getMonth() + 1) + "/" + date.getFullYear() + " " + date.getHours() + ":" + date.getMinutes() + ":" + date.getSeconds() + " ";
        var newProduct = __assign(__assign({}, product), { id: this.count, templateDate: templateDate });
    ...
    FirebaseDao.prototype.deleteProduct = function (id) {
        ...
        var res = db.collection("productos").doc("producto: " + id).delete();
    };
    return FirebaseDao;
}());
